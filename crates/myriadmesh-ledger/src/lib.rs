...
//!     StorageConfig,
//! };
//! use myriadmesh_core::protocol::{NodeId, types::{AdapterType, NODE_ID_SIZE}};
//! use myriadmesh_core::crypto::signing::Signature;
//!
...
mod integration_tests {
    use super::*;
    use myriadmesh_core::crypto::signing::Signature;
    use myriadmesh_core::protocol::{types::NODE_ID_SIZE, NodeId};
    ...
    fn test_ledger_entry_creation() {
        ...
        use myriadmesh_core::protocol::types::AdapterType;
